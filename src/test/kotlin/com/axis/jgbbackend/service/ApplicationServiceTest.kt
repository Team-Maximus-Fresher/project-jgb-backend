...
//        println("By repo"+ applicationRepo?.findByApplicationIdAndProductCode("MLP000000000014","PERSONAL"))
//        println("By service"+ applicationService?.getApplicationOfACustomerByApplicationReferenceIdAndProductCode("MLP000000000014","PERSONAL"))
...
//        println("By app"+application)
//
//        assertEquals(application,applicationService?.getApplicationOfACustomerByApplicationReferenceIdAndProductCode("MLP000000000014","PERSONAL"))
//      //  assertEquals(application,applicationRepo?.findByApplicationIdAndProductCode("MLP000000000014","PERSONAL"))
//
//    }
//}
//
